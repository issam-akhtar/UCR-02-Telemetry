...
####################################
# Step 1: Install yq if Missing (ARM64)
####################################
install_if_missing "yq" 'wget -q "https://github.com/mikefarah/yq/releases/download/v4.30.5/yq_linux_arm64" -O /usr/local/bin/yq && chmod +x /usr/local/bin/yq'
