...
/**
 * Describes mode for formatting date in header of data legend
 */
export declare enum DataLegendHeaderDateMode {
    /**
 ...
 * @hidden
 */
export declare let DataLegendHeaderDateMode_$type: Type;
