...
/**
 * Describes mode for formatting time in header of data legend
 */
export declare enum DataLegendHeaderTimeMode {
    /**
 ...
 * @hidden
 */
export declare let DataLegendHeaderTimeMode_$type: Type;
