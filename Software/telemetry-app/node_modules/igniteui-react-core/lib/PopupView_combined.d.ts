...
export declare class Popup extends Base implements INotifyPropertyChanged {
    ...
    set au(a: boolean);
    private t;
    get v(): PopupPointerPosition;
    set v(a: PopupPointerPosition);
    private cw;
    get c4(): Brush;
    set c4(a: Brush);
    private a0;
    ...
    cr(a: any, b: PopupDirection, c: PopupAlignment): void;
    ca(a: Rect): void;
    ...
    u(): PopupPointerPosition;
    measuringContentSize: (sender: any, args: PopupMeasuringContentSizeEventArgs) => void;
    ce(): void;
}
