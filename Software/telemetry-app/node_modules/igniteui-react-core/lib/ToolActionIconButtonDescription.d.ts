 ...
 * @hidden
 */
export declare class ToolActionIconButtonDescription extends ToolActionDescription {
    static $t: Type;
    protected get_type(): string;
    constructor();
    private d6;
    get tooltipDelay(): number;
    set tooltipDelay(a: number);
    private d5;
    get actualTooltipDelay(): number;
    set actualTooltipDelay(a: number);
    private du;
    ...
    private d9;
    get popupOpeningRef(): string;
    set popupOpeningRef(a: string);
}
