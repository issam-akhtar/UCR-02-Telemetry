 ...
 * @hidden
 */
export declare abstract class WebGridBaseDirectiveDescription extends Description {
    static $t: Type;
 ...
 * @hidden
 */
export declare class WebGridToolbarDescription extends Description {
    static $t: Type;
    protected get_type(): string;
    get type(): string;
    constructor();
    ...
    set name(a: string);
    private h;
    get tools(): WebGridToolbarContentDescription[];
    set tools(a: WebGridToolbarContentDescription[]);
}
