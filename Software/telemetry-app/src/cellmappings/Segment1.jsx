...
// Enhanced Model Component that handles both highlighting, voltage-based coloring, and hover effects
const Model1 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  // Add fallback and error handling
  const { scene = null, nodes = {} } = useGLTF("/3D/Segment1.glb");
...
// Enhanced Segment1 component supporting both highlighting and voltage-based coloring
const Segment1 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  return <Model1 
