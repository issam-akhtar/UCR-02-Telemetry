...
// This is for Segment 2 (Cells 24-46)
...
const Model2 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  // Add fallback and error handling
  const { scene = null, nodes = {} } = useGLTF("/3D/Segment2.glb");
...
// Enhanced Segment2 component supporting both highlighting and voltage-based coloring
const Segment2 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  return <Model2 
