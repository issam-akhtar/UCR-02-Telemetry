...
// This is for Segment 3 (Cells 47-69)
...
const Model3 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  // Add fallback and error handling
  const { scene = null, nodes = {} } = useGLTF("/3D/Segment3.glb");
...
// Enhanced Segment3 component supporting both highlighting and voltage-based coloring
const Segment3 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  return <Model3 
