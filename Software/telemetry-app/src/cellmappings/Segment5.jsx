...
// This is for Segment 5 (Cells 93-115)
...
const Model5 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  // Add fallback and error handling
  const { scene = null, nodes = {} } = useGLTF("/3D/Segment5.glb");
...
// Enhanced Segment5 component supporting both highlighting and voltage-based coloring
const Segment5 = ({ highlightCell = null, cellValues = {}, setHoveredCell }) => {
  return <Model5 
