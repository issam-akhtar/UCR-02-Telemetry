...
// Enhanced default settings with Raspberry Pi optimizations and dashboard settings
const defaultSettings = {
  global: { 
    ...
    batchUpdates: true, // Batch chart updates for better performance
  },
  realTime: {
  ...
  dashboard: {
    ...
    compactMode: false,       // More compact UI for small screens
    useImperialUnits: false,  // Use mph instead of km/h
    showTempInF: false,       // Show temperature in Fahrenheit
    animateGauges: false,     // Disable gauge animations for better performance
    showBatteryStatus: true,  // Show battery status component
    showSpeedGauge: true,     // Show speed gauge component
    showTempGauge: true,      // Show temperature gauge component
    showGpsMap: true,         // Show GPS map component
    showCellHeatmap: true,    // Show cell heatmap component
    showPedalGauge: true,     // Show pedal gauge component
    mapZoomLevel: 15,         // Default map zoom level
    mapMaxPathPoints: 100,    // Maximum number of points to show in the path
  ...
  useEffect(() => {
    ...
    const applyAccessibilitySettings = () => {
      if (prefersReducedMotion.matches) {
        ...
        updateSettings('dashboard', 'animateGauges', false);
      }
    };
